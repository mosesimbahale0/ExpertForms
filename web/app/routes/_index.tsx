          ...
          <div className=" flex flex-col lg:flex-row  w-full">
            <div className="  w-full h-full lg:w-1/2 flex flex-col justify-center items-start gap-16  lg:py-16 lg:p-0 p-2 lg:pr-16 ">
              <div className=" w-full lg:max-w-4xl flex flex-col gap-6 justify-left items-start">
                ...
                >
                  A proactive approach to content moderation and free speech for
          ...
          <div className=" flex flex-col lg:flex-row  w-full justify-center items-center">
            <div className="  w-full h-full lg:w-1/2 flex flex-col justify-center items-start gap-16  lg:py-16 lg:p-0 p-2 lg:pr-16 ">
              <div className=" w-full lg:max-w-4xl flex flex-col gap-6 justify-left items-start">
                ...
                <div className="flex flex-row gap-4 mt-10">
                  <div className="w-1/6">
                    <div className=" w-20 h-20 shadow-lg  rounded-full bg-secondary flex items-center justify-center text-accent">
                      <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="currentColor" d="M4 20v-5h1v4h4v1zm11 0v-1h4v-4h1v5zM4 9V4h5v1H5v4zm15 0V5h-4V4h5v5zm-7 6q-1.237 0-2.119-.881T9 12t.881-2.119T12 9t2.119.881T15 12t-.881 2.119T12 15m0-1q.825 0 1.413-.587T14 12t-.587-1.412T12 10t-1.412.588T10 12t.588 1.413T12 14m0-2" /></svg>
                    </div>
                  </div>
                  <div className="flex flex-col gap-4 w-5/6 divide-y divide-tertiary ">
                    <p className=" font-medium  text-3xl text-text">Improved Accuracy</p>
                    <p className=" text-xs text-left text-text2 pt-2 ">
                      In today's rapidly evolving digital landscape, social media platforms and content providers face an ever-growing challenge: combating harmful content. From hate speech and violence to misinformation and cyberbullying, the proliferation of harmful content poses a significant threat to online safety and responsible communication.
                    </p>
                  </div>
                ...
                <div className="flex flex-row gap-4 mt-10">
                  <div className="w-1/6">
                    <div className=" w-20 h-20 shadow-lg rounded-full bg-secondary flex items-center justify-center text-accent">
                      <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="currentColor" d="M6.05 8.05a7 7 0 0 0-.02 9.88c1.47-3.4 4.09-6.24 7.36-7.93A15.95 15.95 0 0 0 8 19.32c2.6 1.23 5.8.78 7.95-1.37C19.43 14.47 20 4 20 4S9.53 4.57 6.05 8.05" /></svg>
                    </div>
                  </div>
                  <div className="flex flex-col gap-4 w-5/6 divide-y divide-tertiary ">
                    <p className=" font-medium  text-3xl text-text">Reduced Cost</p>
                    <p className=" text-xs text-left text-text2 pt-2 ">
                      In today's rapidly evolving digital landscape, social media platforms and content providers face an ever-growing challenge: combating harmful content. From hate speech and violence to misinformation and cyberbullying, the proliferation of harmful content poses a significant threat to online safety and responsible communication.
                    </p>
                  </div>
                ...
                <div className="flex flex-row gap-4 mt-10">
                  ...
                  <div className="flex flex-col gap-4 w-5/6 divide-y divide-tertiary ">
                    <p className=" font-medium  text-3xl text-text">Improved Security</p>
                    <p className=" text-xs text-left text-text2 pt-2 ">
                      In today's rapidly evolving digital landscape, social media platforms and content providers face an ever-growing challenge: combating harmful content. From hate speech and violence to misinformation and cyberbullying, the proliferation of harmful content poses a significant threat to online safety and responsible communication.
                    </p>
                  </div>
